...
import 'package:ui_journey/widgets/amenities_widget.dart';
import 'package:ui_journey/widgets/confirm_button_widget.dart';
import 'package:ui_journey/widgets/frosted_widget.dart';
import 'package:ui_journey/widgets/rooms_image_widget.dart';
...
class DestinationDetailsPage extends StatelessWidget {
  ...
  Container ratingWidget() {
    return Container(
      ...
      width: 69,
      decoration: BoxDecoration(
        color: JourneyColors.lightGreen1,
        borderRadius: BorderRadius.circular(20),
      ),
      padding: const EdgeInsets.symmetric(horizontal: 5),
      child: const Row(
